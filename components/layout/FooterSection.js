...
export default function FooterSection() {
  ...
  const footerLinks = {
    solutions: [
      { name: "Thermal Transfer", href: "/services/thermal-transfer" },
      { name: "Sustainable Eco-Labels", href: "/services/sustainable-eco-labels" },
      { name: "Automotive & Durable Goods", href: "/services/automotive-durable-goods" },
      { name: "Beauty & Home Care", href: "/services/beauty-home-care" },
      { name: "General Products Labels", href: "/services/general-products" },
      { name: "Food & Beverage Labels", href: "/services/food-beverage" },
      { name: "Pharmaceutical Labels", href: "/services/pharmaceutical-labels" },
    ],
    company: [
